...
import com.example.webonise.blooddonation.adapter.NotificationViewAdapter;
...
//        LatLng l = PlaceDetectionApi.getCurrentPlace();
    ...
    public void CustomNotification(String s) {
        ...
        RemoteViews remoteViews = new RemoteViews(getPackageName(),R.layout.acitivity_custom_notification);
        ...
        Intent intent = new Intent(this, NotificationViewAdapter.class);
