...
import com.example.webonise.blooddonation.adapter.ListHistoryAdapter;
...
public class HistorySQLActivity extends AppCompatActivity implements View.OnClickListener, ListHistoryAdapter.CallBack{

    FloatingActionButton btnToHistoryData;
    private ListView listView;
    private ListHistoryAdapter listAdapter;
    ...
    private void updateList() {
        ...
        listAdapter = new ListHistoryAdapter(historyDBAdapter.fetchAllDetails(),this);
