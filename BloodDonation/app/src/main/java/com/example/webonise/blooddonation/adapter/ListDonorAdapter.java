...
public class ListDonorAdapter extends BaseAdapter implements View.OnClickListener {
   ...
   /* ImageLoader imageLoader = AppController.getInstance().getImageLoader();*/
    ...
    public ListDonorAdapter(Activity activity, List<Donor.DataEntity> dataEntities) {
